...
public sealed class MixerExample : CapeUnitBase
{
    public MixerExample()
    {
        ...
        Ports.Add(new UnitPort("Inlet Port1", "Test Inlet Port1", 
            CapePortDirection.CAPE_INLET, CapePortType.CAPE_MATERIAL));
        Ports.Add(new UnitPort("Inlet Port2", "Test Inlet Port2", 
            CapePortDirection.CAPE_INLET, CapePortType.CAPE_MATERIAL));
        Ports.Add(new UnitPort("Outlet Port", "Test Outlet Port", 
            CapePortDirection.CAPE_OUTLET, CapePortType.CAPE_MATERIAL));

        // Add a real valued parameter using the RealParameter  constructor.
        var real = new RealParameter("PressureDrop",
        ...
        Parameters.Add(new IntegerParameter("Integer Parameter", "This is an example of an integer parameter.", 12, 12,
            0, 100, CapeParamMode.CAPE_INPUT_OUTPUT));

        // Add a real valued parameter using the BooleanParameter  constructor.
        Parameters.Add(new BooleanParameter("Boolean Parameter", "This is an example of a boolean parameter.", false,
        ...
        Parameters.Add(new OptionParameter("OptionParameter", "This is an example of an option parameter.",
            "Test Value", "Test Value", options, true, CapeParamMode.CAPE_INPUT_OUTPUT));
    ...
    protected override void Calculate()
    {
        ...
        catch (Exception pEx)
        {
            ...
            var ex = new CapeInvalidOperationException(
        ...
        try
        {
            ...
            // The following code adds the individual flows to get the total flow for the stream.
            totalFlow1 = in1Flow.Aggregate(totalFlow1, (current, mt) => current + mt);
        ...
        try
        {
            ...
            // in this case, the null returns the property for all components; calculation type, in this case, the 
            // mixture; and lastly, the basis, moles. Result is cast to a double array, and will contain one value.
            var press = in2.GetProp("Pressure", "Overall", null, "Mixture", null);
            if (press[0] < pressure[0]) pressure[0] = press[0];
        ...
        {
            var comException = (COMException)pEx;
            if (comException != null)
            {
        ...
        // Get the outlet material object.
        var outPort = (ICapeThermoMaterialObject)Ports[2].connectedObject;
        ...
        try
        {
            ...
            // Set the outlet pressure to the lower of the to inlet pressures less the value of the 
            // pressure drop parameter.
            pressure[0] -= ((RealParameter)(Parameters[0])).SIValue;
    ...
    /// ben added likne in <see cref="MixerExample"/>, this method must generate that report.
    /// </remarks>
    /// <example>
    ...
    public override string ProduceReport()
    {
        ...
        {
            "Default Report" => base.ProduceReport(),
            "Report 2" => "This is the alternative Report.",
            _ => string.Empty
        };
    }
}