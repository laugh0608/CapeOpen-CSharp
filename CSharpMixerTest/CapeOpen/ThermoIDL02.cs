...
internal interface ICapeThermoCalculationRoutineCOM
{
    ...
    void CalcProp([MarshalAs(UnmanagedType.IDispatch)]object materialObject,
        object props, object phases, string calcType);
    ...
    /// A System.Object containing an System.String array marshalled as a COM Object.</returns>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
...
internal interface ICapeThermoPropertyPackageCOM
{
    ...
    void GetComponentList(ref object compIds,
        ref object formulae, ref object names, ref object boilTemps, ref object molWt, ref object casNo);
    ...
    /// the passed Material Object.</remarks>
    /// <param name = "materialObject">The Material object.</param>
    ...
    /// derivative and non-derivative properties. For instance, a Property Package 
    /// could return the following list:</para>
    /// <para>enthalpy, enthalpy.Dtemperature, entropy, entropy.Dpressure.</para></remarks>
    /// <returns>String list of all supported Properties.
    /// A System.Object containing an System.String array marshalled as a COM Object.</returns>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
...
public interface ICapeThermoEquilibriumServer
{
    ...
    /// <summary>Calculate some equilibrium values</summary>
    /// <remarks>Calculates the equilibrium properties requested. It must set the amounts, compositions, temperature 
    ...
    /// CalcEquilibrium for more information.</remarks>
    ...
    [DispId(1), Description("Method CalcEquilibrium")]
    void CalcEquilibrium([MarshalAs(UnmanagedType.IDispatch)]object materialObject,
        string flashType, object props);

    // CAPE-OPEN exceptions: ECapeUnknown, ECapeInvalidArgument
    /// <summary>Checks that a property is valid.</summary>
    /// <remarks>Checks to see if a given type of flash calculations can be performed and whether the properties can 
    /// be calculated after the flash calculation.</remarks>
    ...
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument 
    /// value was passed, for example UNDEFINED for property.</exception>
    [DispId(2), Description("Method PropCheck")]
    void PropCheck([MarshalAs(UnmanagedType.IDispatch)]object materialObject,
        string flashType,
        object props,
        ref object valid);
    ...
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument 
    /// value was passed, for example UNDEFINED for property.</exception>
    [DispId(3), Description("Method ValidityCheck")]
    void ValidityCheck([MarshalAs(UnmanagedType.IDispatch)]object materialObject,
        object props,
        ref object relList);
    ...
    /// <remarks>Returns the flash types, properties, phases, and calculation types that are supported by a given 
    /// Equilibrium Server Routine.</remarks>
    ...
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument 
    /// value was passed, for example UNDEFINED for property.</exception>
    [DispId(4), Description("Method PropList")]
...
/// <summary>A Material Object is a container of information that describes a Material stream. 
/// Calculations of thermochemical and thermodynamic properties are performed by a 
...
internal interface ICapeThermoMaterialCOM
{
    ...
    /// <exception cref = "ECapeUnknown">The error to be raised when 
    /// other error(s), specified for this operation, are not suitable.</exception>
    [DispId(0x00000001),Description("Method ClearAllProps")]
    void ClearAllProps();
    ...
    /// <remarks><para>The Physical Property values returned by GetOverallProp refer to the overall 
    ...
    void GetOverallProp([In] string property,
        [In] string basis,
        [In][Out]ref object results);
    ...
    /// use of the CAPE-OPEN interfaces. It returns the most frequently requested 
