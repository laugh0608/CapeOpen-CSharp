...
/// <remarks>The ThermoReliability object is still an uncertain
...
public interface ICapeThermoMaterialTemplate
{
    ...
    /// <remarks>Allows a Material Object to be created from the Material Template interface.</remarks>
    ...
    [DispId(1),Description("Method CreateMaterialObject")]
    [return: MarshalAs(UnmanagedType.IDispatch)]
    ICapeThermoMaterialObject CreateMaterialObject();

    /// <summary>Set some property value(s)</summary>
    /// <remarks>Allows custom property and values to be set on the Material Template to 
    /// support pseudo components.</remarks>
    /// <param name = "property">The custom property to set.</param>
    /// <param name = "values">The actual values of the property. A System.Object containing a double 
    /// array marshalled from a COM Object.</param>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    /// <exception cref = "ECapeLicenceError">ECapeLicenceError</exception>
    [DispId(2),Description("Method SetProp")]
...
internal interface ICapeThermoMaterialObjectCOM
{
    ...
    /// <value>The names of the compounds in the material object in a String array 
    /// as a System.Object, which is marshalled as an Object COM-based CAPE-OPEN.</value>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    [DispId(1),Description("Property ComponentIds")]
    object ComponentIds
    {
        get;
    }
    ...
    /// <value>The phases present in the material in a String array as a 
    /// System.Object, which is marshalled as an Object COM-based CAPE-OPEN.</value>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    [DispId(2),Description("Property PhaseIds")]
    object PhaseIds
    {
        get;
    }
    ...
    /// <returns>Values of the requested universal constants in an array of doubles as a 
    /// System.Object, which is marshalled as an Object COM-based CAPE-OPEN.</returns>
    /// <param name = "props">List of universal constants to be retrieved. A System.Object containing a 
    /// String array.</param>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    /// <exception cref = "ECapeNoImpl">ECapeNoImpl</exception>
    [DispId(3),Description("Method GetUniversalConstant")]
    ...
    /// so on. An array of doubles as a System.Object, which is marshalled as an Object 
    /// COM-based CAPE-OPEN.</returns>
    /// <param name = "props">List of component constants. A System.Object containing a String array 
    /// marshalled from a COM Object.</param>
    /// <param name = "compIds">List of component IDs for which constants are to be retrieved. emptyObject 
    /// for all components in the Material Object. A System.Object containing a String 
    /// array marshalled from a COM Object.</param>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    /// <exception cref = "ECapeNoImpl">ECapeNoImpl</exception>
    [DispId(4),Description("Method GetComponentConstant")]
    ...
    /// <param name = "props">The List of Properties to be calculated. A System.Object containing a String 
    /// array.</param>
    /// <param name = "phases">List of phases for which the properties are to be calculated. A System.Object 
    /// containing a String array.</param>
    ...
    /// <exception cref = "ECapeLicenceError">ECapeLicenceError</exception>
    [DispId(5),Description("Method CalcProp")]
    ...
    /// A System.Object containing a String array marshalled from a COM Object.</param>
    ...
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    [DispId(6),Description("Method GetProp")]
    object GetProp(string property,
        string phase, object compIds, string calcType, string basis);
    ...
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    [DispId(7),Description("Method SetProp")]
    void SetProp(string property,
        string phase, object compIds, string calcType, string basis, object values);
    ...
    [DispId(9),Description("Method SetIndependentVar")]
    ...
    /// An array of doubles as a System.Object, which is marshalled as an Object 
    /// COM-based CAPE-OPEN. </returns>
    [DispId(10),Description("Method GetIndependentVar")]
    ...
    /// <returns>Returns Boolean List associated to list of properties to be checked.
    /// An array of booleans (VT_BOOL) as a System.Object, which is marshalled as an 
    /// Object COM-based CAPE-OPEN. </returns>
    /// <param name = "props">Properties to check. A System.Object containing a String array marshalled from 
    /// a COM Object.</param>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    [DispId(11),Description("Method PropCheck")]
    ...
    /// <returns>Properties for which results are available.in a String array as a 
    /// System.Object, which is marshalled as an Object COM-based CAPE-OPEN.</returns>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    [DispId(12),Description("Method AvailableProps")]
    ...
    /// <param name = "props">Properties to be removed. emptyObject to remove all properties. A 
    /// System.Object containing a String array marshalled from a COM Object.</param>
    [DispId(13),Description("Method RemoveResults")]
    ...
    /// <exception cref = "ECapeOutOfResources">ECapeOutOfResources</exception>
    /// <exception cref = "ECapeLicenceError">ECapeLicenceError</exception>
    [DispId(14),Description("Method CreateMaterialObject")]
    [return: MarshalAs(UnmanagedType.IDispatch)]
    ...
    /// <param name = "props">The properties for which reliability is checked. emptyObject to remove all 
    /// properties. A System.Object containing a String array marshalled from a COM Object.</param>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    [DispId(16),Description("Method ValidityCheck")]
    ...
    /// <returns>String list of all supported properties of the property package.
    /// A System.Object containing a String array marshalled from a COM Object.</returns>
    [DispId(17),Description("Method GetPropList")]
    object GetPropList();
    ...
    /// <value>Number of components in the Material Object.</value>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    [DispId(18),Description("Method GetNumComponents")]
...
public interface ICapeThermoMaterialObject
{
    /// <summary>Get the component ids for this MO</summary>
    /// <remarks>Returns the list of components Ids of a given Material Object.</remarks>
    /// <returns>The names of the compounds in the material object in a String array 
    /// as a System.Object, which is marshalled as an Object COM-based CAPE-OPEN.</returns>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    [DispId(1),Description("Property ComponentIds")]
    string[] ComponentIds { get; }
    ...
    /// <exception cref = "ECapeLicenceError">ECapeLicenceError</exception>
    [DispId(5), Description("Method CalcProp")]
    void CalcProp(string[] props, string[] phases, string calcType);
    ...
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    [DispId(6), Description("Method GetProp")]
    double[] GetProp(string property,
    ...
    /// <exception cref = "ECapeOutOfBounds">ECapeOutOfBounds</exception>
    /// <exception cref = "ECapeLicenceError">ECapeLicenceError</exception>
    [DispId(8), Description("Method CalcEquilibrium")]
    void CalcEquilibrium(string flashType, string[] props);
...
/// <summary>Interface that provides access to property packages supported by a Thermodynamics Package.</summary>
/// <remarks><para>This interface is used to access the various substiuent Property Packages provided by a thermodynamic system.</para>
...
internal interface ICapeThermoSystemCOM
{
    ...
    /// <remarks>Returns StringArray of property pacakge names supported by the thermo system.</remarks>
    /// <returns>The returned set of supported property packages.
    /// A System.Object containing a String array marshalled from a COM Object.</returns>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeFailedInitialisation">ECapeFailedInitialisation</exception>
    /// <exception cref = "ECapeNoImpl">ECapeNoImpl</exception>
    [DispId(1), Description("Method GetPropertyPackages")]
    object GetPropertyPackages();

    /// <summary>Resolve a particular property package</summary>
    /// <remarks>Resolves referenced property package to a property package interface.</remarks>
    /// <returns>The Property Package Interface.</returns>
    /// <param name = "propertyPackage">The property package to be resolved.</param>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    /// <exception cref = "ECapeFailedInitialisation">ECapeFailedInitialisation</exception>
    [DispId(2), Description("Method ResolvePropertyPackage")]
    [return: MarshalAs(UnmanagedType.IDispatch)]
...
//class CapeThermoSystem
/// <summary>Interface that provides access to property packages supported by a Thermodynamics Package.</summary>
/// <remarks><para>This interface is used to access the various subsequent Property Packages provided by a thermodynamic system.</para>
/// <para>In the class library, the <see cref ="CapeThermoSystem">CapeThermoSystem</see> class provides a list of all
/// classes Property Packages registered with COM and all .Net-based property packages that are contained in the Global Assembly Cache.</para></remarks>
[ComVisible(false)]
[Description("ICapeThermoSystem Interface")]
public interface ICapeThermoSystem
{
    ...
    [DispId(2), Description("Method ResolvePropertyPackage")]
    [return: MarshalAs(UnmanagedType.IDispatch)]
    ICapeThermoPropertyPackage ResolvePropertyPackage(string propertyPackage);
}

/// <summary>Interface implemented by a CAPE-OPEN version 1.0 Physical Property Package.</summary>
/// <remarks><para>A Simple Properties Package (SPP) is a complete, consistent, reusable, ready-to-use collection of 
...
{
    // CAPE-OPEN exceptions ECapeUnknown
    /// <summary>Get the phase list</summary>
    /// <remarks>Provides the list of the supported phases. When supported, the Overall phase 
    /// and multiphase identifiers must be returned by this method.</remarks>
    /// <returns>The list of phases supported by the property package.
    /// A System.Object containing a String array marshalled from a COM Object.</returns>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    [DispId(1), Description("Method GetPhaseList")]
    object GetPhaseList();

    /// <summary>Get the component list</summary>
    /// <remarks><para>Returns the list of components of a given property package.</para>
    ...
    /// casRegistryNumber property identifier.</para></remarks>
    /// <param name = "compIds">Reference value to the list of component IDs.
    /// A reference to a System.Object containing a String array marshalled from a 
    /// COM Object.</param>
    /// <param name = "formulae">List of component formulae.
    /// A reference to a System.Object containing a String array marshalled from a 
    /// COM Object.</param>
    /// <param name = "names">List of component names.
    /// A reference to a System.Object containing a String array marshalled from a 
    /// COM Object.</param>
    /// <param name = "boilTemps">List of boiling point temperatures.
    /// A reference to a System.Object containing a double array marshalled from a 
    /// COM Object.</param>
    /// <param name = "molWt">List of molecular weight.
    /// A reference to a System.Object containing a double array marshalled from a 
    /// COM Object.</param>
    /// <param name = "casNo">List of CAS number.
    /// A reference to a System.Object containing a String array marshalled from a 
    /// COM Object.</param>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    [DispId(2), Description("Method GetComponentList")]
    void GetComponentList(ref string[] compIds,
        ref string[] formulae, ref string[] names, 
        ref double[] boilTemps, ref double[] molWt, ref string[] casNo);

    /// <summary>Get some universal constant(s)</summary>
    /// <remarks>Returns the values of the Universal Constants.</remarks>
    /// <param name = "materialObject">The Material object.</param>
    /// <param name = "props">List of requested universal constants.
    /// A reference to a System.Object containing a String array marshalled as a 
    /// COM Object.</param>
    /// <returns>Values of universal constants.
    /// A reference to a System.Object containing a System.Object array marshalled 
    /// from a COM Object.</returns>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    [DispId(3), Description("Method GetUniversalConstant")]
    ...
    /// <summary>Get some pure component constant(s)</summary>
    /// <remarks>Returns the values of the Constant properties of the components contained in 
    /// the past Material Object.</remarks>
    /// <param name = "materialObject">The Material object.</param>
    /// <param name = "props">The list of properties.
    /// A reference to a System.Object containing a String array marshalled as a 
    /// COM Object.</param>
    /// <returns>Component Constant values. See description of return value of the 
    ...
    /// <summary>Calculate some properties.</summary>
    /// <remarks>This method is responsible for doing all calculations and is implemented by 
    ...
    /// Section.</remarks>
    /// <param name = "materialObject">The MaterialObject for the Calculation.</param>
    /// <param name = "props">The List of Properties to be calculated.
    /// A reference to a System.Object containing a String array marshalled as a 
    /// COM Object.</param>
    /// <param name = "phases">List of phases for which the properties are to be calculated.
    /// A reference to a System.Object containing a String array marshalled as a 
    /// COM Object.</param>
    /// <param name = "calcType">Type of calculation: Mixture Property or Pure Component Property. For partial 
    /// property, such as fugacity coefficients of components in a mixture, use 
    ...
    /// <summary>Calculate some equilibrium values</summary>
    /// <remarks>Method responsible for calculating/delegating flash calculation requests. It 
    ...
    /// and CalcEquilibrium for more information.</remarks>
    /// <param name = "materialObject">The MaterialObject for the Calculation.</param>
    /// <param name = "props">Properties to be calculated at equilibrium. emptyObject for no properties. 
    /// If a list, then the property values should be set for each phase present at 
    /// equilibrium.
    ...
    /// <exception cref = "ECapeOutOfBounds">ECapeOutOfBounds</exception>
    /// <exception cref = "ECapeLicenceError">ECapeLicenceError</exception>
    [DispId(6), Description("Method CalcEquilibrium")]
    ...
    /// <returns>The array of booleans for each property.
    /// A System.Object containing a System.Boolean (marshalled as VT_BOOL) array 
    /// marshalled as a COM Object.</returns>
    /// <param name = "materialObject">The MaterialObject for the Calculation.</param>
    /// <param name = "props">List of Properties to check.
    /// A System.Object containing a String array marshalled as a COM Object.</param>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    [DispId(7), Description("Method PropCheck")]
    object PropCheck([MarshalAs(UnmanagedType.IDispatch)]object materialObject, object props);

    /// <summary>Check the validity of the given properties</summary>
    /// <remarks>Checks the validity of the calculation.</remarks>
    /// <returns>The properties for which reliability is checked.
    /// A System.Object containing a System.Boolean (marshalled as VT_BOOL) array 
    /// marshalled as a COM Object.</returns>
    /// <param name = "materialObject">The MaterialObject for the Calculation.</param>
    /// <param name = "props">List of Properties to check.
    ...
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    [DispId(8), Description("Method ValidityCheck")]
    object ValidityCheck([MarshalAs(UnmanagedType.IDispatch)]object materialObject, object props);

    /// <summary>Get the list of properties</summary>
    /// <remarks><para>Returns list of Thermo System supported properties. The properties TEMPERATURE, 
    /// PRESSURE, FRACTION, FLOW, PHASE FRACTION, TOTAL FLOW cannot be returned by 
    ...
    /// could return the following list:</para>
    /// <para>enthalpy, enthalpy.Temperature, entropy, entropy.Pressure.</para></remarks>
    /// <returns>String list of all supported Properties.
    /// A System.Object containing a System.String array marshalled as a COM Object.</returns>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    [DispId(9), Description("Method GetPropList")]
    object GetPropList();
}
...
{
    /// <summary>Calculate some properties</summary>
    /// <remarks>This method is responsible for doing all calculations on behalf of the 
    /// calculation routine component. This method is further defined in the 
    /// descriptions of the CAPE-OPEN Calling Pattern and the User Guide Section.</remarks>
    /// <param name = "materialObject">The MaterialObject for the Calculation.</param>
    /// <param name = "props">The List of Properties to be calculated.
    /// A reference to a System.Object containing a String array marshalled as a 
    /// COM Object.</param>
    ...
    void CalcProp(ICapeThermoMaterialObject materialObject,
        string[] props, string[] phases, string calcType);
    ...
    /// derivative and non-derivative properties. For instance, a Property Package 
    /// could return the following list:</para>
    /// <para>enthalpy, enthalpy.Temperature, entropy, entropy.Pressure.
    /// </para></remarks>
    /// <returns>String list of all supported Properties.
    /// A System.Object containing a System.String array marshalled as a COM Object.</returns>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    [DispId(3), Description("Method GetPropList")]
    ...
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    [DispId(4), Description("Method ValidityCheck")]
