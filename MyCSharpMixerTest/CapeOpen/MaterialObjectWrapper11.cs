...
internal class MaterialObjectWrapper11 : CapeObjectBase,
    ICapeThermoMaterial, ICapeThermoCompounds, ICapeThermoPhases,
    ICapeThermoUniversalConstant, ICapeThermoEquilibriumRoutine, ICapeThermoPropertyRoutine
{        
    [NonSerialized]
    ...
    public MaterialObjectWrapper11(object materialObject)
    {
        ...
        if (materialObject is not ICapeThermoMaterialCOM thermoMaterialCom) return;
        _pIMatObj = thermoMaterialCom;
        _pIPropertyRoutine = (ICapeThermoPropertyRoutineCOM)thermoMaterialCom;
        _pIUniversalConstant = (ICapeThermoUniversalConstantCOM)thermoMaterialCom;
        _pIPhases = (ICapeThermoPhasesCOM)thermoMaterialCom;
        _pICompounds = (ICapeThermoCompoundsCOM)thermoMaterialCom;
        _pIEquilibriumRoutine = (ICapeThermoEquilibriumRoutineCOM)thermoMaterialCom;
    }
    ...
    public static bool SupportsThermo10 => false;
    ...
    public static bool SupportsThermo11 => true;
    ...
    [Description("Unit Operation Parameter Collection. Click on the (...) button to edit collection.")]
    [Category("CapeIdentification")]
    public static object MaterialObject10 => null;
    ...
    void ICapeThermoPhases.GetPhaseList(ref string[] phaseLabels, ref string[] stateOfAggregation, ref string[] keyCompoundId)
    {
        ...
        object mObj = null;
        object kObj = null;
        _pIPhases.GetPhaseList(ref pObj, ref mObj, ref kObj);
        phaseLabels = (string[])pObj;
        stateOfAggregation = (string[])mObj;
        keyCompoundId = (string[])kObj;
    }
    ...
    void ICapeThermoCompounds.GetCompoundList(ref string[] compIds, ref string[] formulae, ref string[] names, ref double[] boilTemps, ref double[] molwts, ref string[] casnos)
    {
        ...
        object molObj = null;
        object casObj = null;
        _pICompounds.GetCompoundList(ref comObj, ref formObj, ref namObj, ref boilObj, ref molObj, ref casObj);
        compIds = (string[])comObj;
        formulae = (string[])formObj;
        names = (string[])namObj;
        boilTemps = (double[])boilObj;
        molwts = (double[])molObj;
        casnos = (string[])casObj;
    }
        ...
        ref double[] lnPhi, ref double[] lnPhiDt, ref double[] lnPhiDp, ref double[] lnPhiDn)
    {
        ...
        _pIPropertyRoutine.CalcAndGetLnPhi(phaseLabel, temperature, pressure, moleNumbers, flags, ref pObj, ref dtObj, ref dpObj, ref dnObj);
        lnPhi = (double[])pObj;
    ...
    /// Calculation in the same format as pSpecification.</param>
    ...
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s), 
    /// specified for this operation, are not suitable.</exception>
    void ICapeThermoEquilibriumRoutine.CalcEquilibrium(string[] pSpecification, string[] mSpecification, string solutionType)
    {
    ...
    /// <remarks><para>The meaning of the pSpecification, mSpecification and solutionType 
    ...
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s), 
    /// specified for this operation, are not suitable.</exception>
    bool ICapeThermoEquilibriumRoutine.CheckEquilibriumSpec(string[] pSpecification, string[] mSpecification, string solutionType)
    {
