...
internal class MaterialObjectWrapper : CapeObjectBase,
    ...
    ICapeThermoPhases, ICapeThermoUniversalConstant, ICapeThermoEquilibriumRoutine,
    ICapeThermoPropertyRoutine
{
    ...
    public MaterialObjectWrapper(object materialObject)
    {
        ...
        if (materialObject is not ICapeThermoMaterialCOM materialCom) return;
        SupportsThermo11 = true;
        _pIMatObj = materialCom;
        _pIPropertyRoutine = (ICapeThermoPropertyRoutineCOM)materialCom;
        _pIUniversalConstant = (ICapeThermoUniversalConstantCOM)materialCom;
        _pIPhases = (ICapeThermoPhasesCOM)materialCom;
        _pICompounds = (ICapeThermoCompoundsCOM)materialCom;
        _pIEquilibriumRoutine = (ICapeThermoEquilibriumRoutineCOM)materialCom;
    }
    ...
    /// An array of doubles as a System.Object, which is marshalled as an Object COM-based CAPE-OPEN. </param>
    ...
    /// <summary>Returns Phase labels for the Phases that are currently present in the Material Object.</summary>
    ...
    /// GetOverallTPFraction method of the ICapeThermoMaterial interface should be used.</para></remarks>
    ...
    {
        object pObj = null;
        _pIMatObj.GetTPFraction(phaseLabel, temperature, pressure, pObj);
        composition = (double[])pObj;
    }

    /// <summary>Retrieves two-phase non-constant Physical Property values for a mixture.</summary>
    /// <remarks><para>The results argument returned by GetTwoPhaseProp is either a CapeArrayDouble 
    /// that contains one or more numerical values, e.g. values, or a CapeInterface 
    ...
    /// values argument is outside the range of values accepted by the Material 
    /// Object.</exception>
    ...
    /// contains one or more numerical values to be set for a property, e.g. values, 
    ...
    /// more numerical values to be set for a property, e.g. values, or a CapeInterested to set two-phase 
    /// properties described by a more complex data structure properties.</para></remarks>
    /// <param name = "property">The property for which values are set in the 
    /// Material Object. This must be one of the two-phase properties or derivatives 
    /// included in sections 7.5.6 and 7.6.</param>
    /// <param name = "phaseLabels">Phase labels of the Phases for 
        ...
        ref string[] keyCompoundId)
    {
        ...
        object mObj = null;
        object vObj = null;
        _pIPhases.GetPhaseList(ref pObj, ref mObj, ref vObj);
        phaseLabels = (string[])pObj;
        stateOfAggregation = (string[])mObj;
        keyCompoundId = (string[])vObj;
    }
    ...
    /// Compounds is C, the proposals array will contain C*P variants. The first C 
    ...
    /// <para>molts - molecularWeight</para>
    /// <para>casinos casRegistryNumber</para>
    ...
    /// other client, will use the casinos argument rather than the compIds. This is 
    /// because different PMEs may give different names to the same Compounds and the
    /// casinos is (almost always) unique. If the casinos is not available (e.g. for 
    ...
    /// <param name = "casinos">List of Chemical Abstract Service (CAS) Registry
    /// numbers.</param>
    ...
    void ICapeThermoCompounds.GetCompoundList(ref string[] compIds, ref string[] formulae, ref string[] names,
        ref double[] boilTemps, ref double[] molwts, ref string[] casinos)
    {
        object comObj = null;
        object formObj = null;
        object nameObj = null;
        ...
        object molObj = null;
        object casObj = null;
        _pICompounds.GetCompoundList(ref comObj, ref formObj, ref nameObj, ref boilObj, ref molObj, ref casObj);
        compIds = (string[])comObj;
        formulae = (string[])formObj;
        names = (string[])nameObj;
        boilTemps = (double[])boilObj;
        molwts = (double[])molObj;
        casinos = (string[])casObj;
    }
    ...
    /// Compounds is C, the proposals array will contain C*P values. The first C 
    ...
    /// <exception cref = "ECapeOutOfBounds">The value of the pressure is outside
    ...
    {
        object pObj = null;
        _pICompounds.GetPDependentProperty(props, pressure, compIds, ref pObj);
        propVals = (double[])pObj;
    }
    ...
    /// check which Physical Properties are available.</para>
    /// <para>If the number of requested Physical Properties is P and the number of 
    /// Compounds is C, the proposals array will contain C*P values. The first C will 
    ...
    {
        object pObj = null;
        _pICompounds.GetTDependentProperty(props, temperature, compIds, ref pObj);
        propVals = (double[])pObj;
    }
    ...
    ///	Property Calculation are not valid. Forex ample, the composition of the phase is 
    ...
    void ICapeThermoPropertyRoutine.CalcAndGetLnPhi(string phaseLabel, double temperature,
        double pressure, double[] moleNumbers,
        CapeFugacityFlag fFlags, ref double[] lnPhi, ref double[] lnPhiDt,
        ref double[] lnPhiDp, ref double[] lnPhiDn)
    {
        object phiObj = null;
        object dtObj = null;
        object dpObj = null;
        ...
        _pIPropertyRoutine.CalcAndGetLnPhi(phaseLabel, temperature, pressure, 
            moleNumbers, flags, ref phiObj, ref dtObj, ref dpObj, ref dnObj);
        lnPhi = (double[])phiObj;
        lnPhiDt = (double[])dtObj;
        lnPhiDp = (double[])dpObj;
        lnPhiDn = (double[])dnObj;
    }
    ...
    /// for example, a vapour-liquid, liquid-liquid, or vapour-liquid-liquid calculation 
