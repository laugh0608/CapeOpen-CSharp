...
/// when you use a COM-based CAPE-OPEN material object.
/// </para>
/// </remarks>
[ComVisible(false)]
[Guid("5A65B4B2-2FDD-4208-813D-7CC527FB91BD")]
[Description("ICapeThermoMaterialObject Interface")]
internal class MaterialObjectWrapper10 : CapeObjectBase,
    ICapeThermoMaterialObject
{
    ...
    /// </summary>
    /// <remarks>
    /// The <see cref = "MaterialObjectWrapper10"/> class checks to determine whether the wrapped material object
    ...
    /// an apply (see also Specific properties).
    /// </param>
    /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
    /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognised Compound identifier or UNDEFINED for the props' argument.</exception>
    ...
    //    {
    //        throw CapeOpen.COMExceptionHandler.ExceptionForHRESULT(p_MaterialObject, pEx);
    //    }
    //}
    /// <summary>
