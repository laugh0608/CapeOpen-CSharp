namespace CapeOpen;
	...
	/// </summary>
	/// <remarks>
	/// This enumeration provide the flow sheeting tool with information related to the direction of the port, that is, whether the port take in
...
*/
    ...
    /// <remarks>
    /// <para>
    /// The unit port provides the means by which a Flowsheet Unit is connected to its streams. 
